...
- Never commit **`autoagents/logs/`** (orchestrator stdout; gitignored).
...
- The orchestrator skips this agent when the only dirt is stamps/logs (noise). If you were invoked, assume there is substantive work to consider.
